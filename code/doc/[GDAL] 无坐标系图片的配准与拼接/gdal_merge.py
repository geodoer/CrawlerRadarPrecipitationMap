...
# https://gdal.org/gdal_merge.html
...
if __name__ == '__main__':
    """ 参数说明：https://gdal.org/gdal_merge.html
    """
    # 命令行调用
    # sys.exit(main())
    in_files = [
        r'D:\mycode\GISandPython\1.3 GDAL\1example\图像处理实例\data\registration\2,2 2019-04-09 19-54-44.tif',
        r'D:\mycode\GISandPython\1.3 GDAL\1example\图像处理实例\data\registration\2,0 2019-04-09 19-55-47.tif',
        r'D:\mycode\GISandPython\1.3 GDAL\1example\图像处理实例\data\registration\1,1 2019-04-09 19-58-00.tif',
    ]
    out_path = r'D:\mycode\GISandPython\1.3 GDAL\1example\图像处理实例\data\mosaic\2019-04-09 19-58-00.tif'
